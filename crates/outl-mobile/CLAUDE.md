...
Two cross-runtime contracts live here.
...
2. **Caret offset.** `textarea.selectionStart` is a UTF-16 code unit offset; the Rust backend expects a Unicode codepoint count.
